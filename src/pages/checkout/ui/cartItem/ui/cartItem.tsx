...
import {BoostOrder} from "pages/checkout/ui/cartItem/ui/OrderedServicesUi/boostOrder/boostOrder";
    ...
    return(
        <div className={cls.itemContainer}>
            <div className={cls.itemHeading}>
                ...
                <DeleteButton onCLick={()=>{onDeleteClicked()}}></DeleteButton>
            </div>
            ...
            <div className={cls.quantityContainer}>
                ...
                <div className={cls.content}>
                    <InputNumber
                        ...
                        onIncrement={()=>{}}
                    />
                    <div className={cls.priceBlock}>0.72$</div>
                </div>
            </div>
